...
from apps.core.admin import BaseProcessActionsAdminMixin


class CRUDHistoryMixin(BaseProcessActionsAdminMixin, admin.ModelAdmin):
    CRUD_HISTORY = "crud_history"
    crud_history_translated_title = _('CRUD history')

    def get_urls(self) -> list:
        urls = super(CRUDHistoryMixin, self).get_urls()
    ...
    def get_action_methods(self) -> dict:
        methods = super(CRUDHistoryMixin, self).get_action_methods()
        methods.update(
